...
var AvatarCard = ({
  ...
  return /* @__PURE__ */ React3.createElement("div", { style: { background: bg, borderRadius: "20px", padding: "20px", width: "280px", fontFamily: "system-ui,sans-serif", border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 10px 40px rgba(0,0,0,0.4)" } }, /* @__PURE__ */ React3.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: "12px" } }, /* @__PURE__ */ React3.createElement("img", { src: avatar, alt: name, style: { width: "80px", height: "80px", borderRadius: "50%", border: "3px solid " + alpha(accent, 0.3) } }), /* @__PURE__ */ React3.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React3.createElement("div", { style: { fontSize: "18px", fontWeight: "700", color: "#fff" } }, name), /* @__PURE__ */ React3.createElement("div", { style: { fontSize: "13px", color: "rgba(255,255,255,0.45)" } }, role)), /* @__PURE__ */ React3.createElement("div", { style: { display: "flex", gap: "16px", marginTop: "8px" } }, stats.map((stat, i) => /* @__PURE__ */ React3.createElement("div", { key: i, style: { textAlign: "center" } }, /* @__PURE__ */ React3.createElement("div", { style: { fontSize: "16px", fontWeight: "700", color: "#fff" } }, stat.value), /* @__PURE__ */ React3.createElement("div", { style: { fontSize: "12px", color: "rgba(255,255,255,0.35)" } }, stat.label)))), /* @__PURE__ */ React3.createElement("button", { onClick: onFollowClick, style: { width: "100%", padding: "10px", borderRadius: "10px", border: "none", background: "linear-gradient(135deg, " + accent + ", " + alpha(accent, 0.7) + ")", color: "#fff", fontSize: "14px", fontWeight: "700", cursor: "pointer", fontFamily: "inherit" } }, "Follow")));
};
...
import React11, { useState as useState8, useEffect as useEffect4, useCallback } from "react";
...
import React12, { useState as useState9, useEffect as useEffect5 } from "react";
var PageLoader = ({
  logo = "VirtualAI",
  accent = "#6366f1",
  bg = "",
...
import React13, { useState as useState10, useRef, useEffect as useEffect6 } from "react";
var OTPInput = ({
  length = 6,
  onComplete = () => {
  },
...
import React18, { useEffect as useEffect7, useRef as useRef3, useState as useState15 } from "react";
var StatCard = ({
  title = "Active Users",
  value = "128K",
  numericValue = 128e3,
...
import React19, { useEffect as useEffect8, useRef as useRef4, useState as useState16 } from "react";
var ProgressBar = ({
  label = "Progress",
  percentage = 75,
  accent = "#6366f1",
...
import React26, { useState as useState22 } from "react";
var Toggle = ({
  checked = false,
  onChange = () => {
  },
  ...
  const [isOn, setIsOn] = useState22(checked);
  const alpha = (hex, op) => {
    const r = parseInt(hex.slice(1, 3), 16), g = parseInt(hex.slice(3, 5), 16), b = parseInt(hex.slice(5, 7), 16);
    return "rgba(" + r + "," + g + "," + b + "," + op + ")";
  };
...
import React27, { useState as useState23 } from "react";
var PhotoCard = ({
  image = "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&q=80",
  title = "Mountain Majesty",
  description = "Experience the breathtaking views of snow-capped peaks and serene valleys.",
  tag = "Nature",
  accent = "#6366f1",
  bg = "#0f172a",
  onButtonClick = () => {
  ...
  return /* @__PURE__ */ React27.createElement(
    ...
    /* @__PURE__ */ React27.createElement("div", { style: { position: "relative", width: "100%", height: "160px", overflow: "hidden" } }, /* @__PURE__ */ React27.createElement("img", { src: image, alt: title, style: { width: "100%", height: "100%", objectFit: "cover", transform: hovered ? "scale(1.05)" : "scale(1)", transition: "transform 0.4s ease" } }), /* @__PURE__ */ React27.createElement("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(0,0,0,0.5) 0%, transparent 60%)" } }), tag && /* @__PURE__ */ React27.createElement("div", { style: { position: "absolute", top: "12px", left: "12px", padding: "4px 10px", borderRadius: "20px", background: alpha(accent, 0.85), fontSize: "10px", fontWeight: "700", color: "#fff", textTransform: "uppercase", letterSpacing: "0.5px" } }, tag)),
    /* @__PURE__ */ React27.createElement("div", { style: { padding: "16px" } }, /* @__PURE__ */ React27.createElement("h3", { style: { fontSize: "15px", fontWeight: "700", color: "#fff", margin: "0 0 8px", lineHeight: 1.4 } }, title), /* @__PURE__ */ React27.createElement("p", { style: { fontSize: "13px", color: "rgba(255,255,255,0.45)", lineHeight: 1.65, margin: "0 0 16px" } }, description), /* @__PURE__ */ React27.createElement(
      "button",
      {
        onClick: onButtonClick,
