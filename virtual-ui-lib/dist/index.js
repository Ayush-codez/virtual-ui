...
var AvatarCard = ({
  ...
  return /* @__PURE__ */ import_react3.default.createElement("div", { style: { background: bg, borderRadius: "20px", padding: "20px", width: "280px", fontFamily: "system-ui,sans-serif", border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 10px 40px rgba(0,0,0,0.4)" } }, /* @__PURE__ */ import_react3.default.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: "12px" } }, /* @__PURE__ */ import_react3.default.createElement("img", { src: avatar, alt: name, style: { width: "80px", height: "80px", borderRadius: "50%", border: "3px solid " + alpha(accent, 0.3) } }), /* @__PURE__ */ import_react3.default.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ import_react3.default.createElement("div", { style: { fontSize: "18px", fontWeight: "700", color: "#fff" } }, name), /* @__PURE__ */ import_react3.default.createElement("div", { style: { fontSize: "13px", color: "rgba(255,255,255,0.45)" } }, role)), /* @__PURE__ */ import_react3.default.createElement("div", { style: { display: "flex", gap: "16px", marginTop: "8px" } }, stats.map((stat, i) => /* @__PURE__ */ import_react3.default.createElement("div", { key: i, style: { textAlign: "center" } }, /* @__PURE__ */ import_react3.default.createElement("div", { style: { fontSize: "16px", fontWeight: "700", color: "#fff" } }, stat.value), /* @__PURE__ */ import_react3.default.createElement("div", { style: { fontSize: "12px", color: "rgba(255,255,255,0.35)" } }, stat.label)))), /* @__PURE__ */ import_react3.default.createElement("button", { onClick: onFollowClick, style: { width: "100%", padding: "10px", borderRadius: "10px", border: "none", background: "linear-gradient(135deg, " + accent + ", " + alpha(accent, 0.7) + ")", color: "#fff", fontSize: "14px", fontWeight: "700", cursor: "pointer", fontFamily: "inherit" } }, "Follow")));
};
...
var Toggle = ({
  ...
  const [isOn, setIsOn] = (0, import_react26.useState)(checked);
  const alpha = (hex, op) => {
    const r = parseInt(hex.slice(1, 3), 16), g = parseInt(hex.slice(3, 5), 16), b = parseInt(hex.slice(5, 7), 16);
    return "rgba(" + r + "," + g + "," + b + "," + op + ")";
  };
...
var PhotoCard = ({
  ...
  const [hovered, setHovered] = (0, import_react27.useState)(false);
  const alpha = (hex, op) => {
    const r = parseInt(hex.slice(1, 3), 16), g = parseInt(hex.slice(3, 5), 16), b = parseInt(hex.slice(5, 7), 16);
    return "rgba(" + r + "," + g + "," + b + "," + op + ")";
  };
  return /* @__PURE__ */ import_react27.default.createElement(
    ...
    /* @__PURE__ */ import_react27.default.createElement("div", { style: { position: "relative", width: "100%", height: "160px", overflow: "hidden" } }, /* @__PURE__ */ import_react27.default.createElement("img", { src: image, alt: title, style: { width: "100%", height: "100%", objectFit: "cover", transform: hovered ? "scale(1.05)" : "scale(1)", transition: "transform 0.4s ease" } }), /* @__PURE__ */ import_react27.default.createElement("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(0,0,0,0.5) 0%, transparent 60%)" } }), tag && /* @__PURE__ */ import_react27.default.createElement("div", { style: { position: "absolute", top: "12px", left: "12px", padding: "4px 10px", borderRadius: "20px", background: alpha(accent, 0.85), fontSize: "10px", fontWeight: "700", color: "#fff", textTransform: "uppercase", letterSpacing: "0.5px" } }, tag)),
    /* @__PURE__ */ import_react27.default.createElement("div", { style: { padding: "16px" } }, /* @__PURE__ */ import_react27.default.createElement("h3", { style: { fontSize: "15px", fontWeight: "700", color: "#fff", margin: "0 0 8px", lineHeight: 1.4 } }, title), /* @__PURE__ */ import_react27.default.createElement("p", { style: { fontSize: "13px", color: "rgba(255,255,255,0.45)", lineHeight: 1.65, margin: "0 0 16px" } }, description), /* @__PURE__ */ import_react27.default.createElement(
      "button",
      {
        onClick: onButtonClick,
