...
const steps = [
  { n:"01", title:"Install Library",  text:"npm install virtual-ui-component-library to access all prebuilt UI components." },
      ...
      <section className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-16 sm:pt-24 pb-12 sm:pb-20 text-center">
        ...
        <motion.div {...fadeUp(0.27)} className="flex justify-center mb-7 sm:mb-8 px-2">
          <div className="flex items-center gap-2 sm:gap-3 bg-white/[0.04] border border-white/10 rounded-xl px-4 sm:px-5 py-3 text-xs sm:text-sm font-mono w-full max-w-xs sm:max-w-fit">
            ...
            <span className="text-white/80 truncate">npm install virtual-ui-component-library</span>
        ...
        >
          ...
          <div className="font-mono text-[11px] sm:text-[12.5px] leading-6 space-y-0.5 min-w-[280px]">
            <p><span className="text-[#3be8ff]/60">import</span> <span className="text-white/80">{"{ Button, Card }"}</span> <span className="text-[#3be8ff]/60">from</span> <span className="text-[#aaff80]/70">'virtual-ui-component-library'</span><span className="text-white/30">;</span></p>
